...
class ProfRegistrarCurso extends StatefulWidget {
  ...
  @override
  State<ProfRegistrarCurso > createState() => _ProfTomarAsistenciaState();
}

class _ProfTomarAsistenciaState extends State<ProfRegistrarCurso > {
  ...
  Future<void> _registrarCurso() async {
    if (_formKey.currentState!.validate()) {
      final curso = Curso(
        ...
        idProfesor: "4CZv6v4huRSV3QUxo2R7",
      );
